...
const int led2 = 2;
const int led3 = 1;
const int button1 = 13;  // Tombol untuk running dari kiri ke kanan
const int button2 = 12;  // Tombol untuk running dari kanan ke kiri
const int button3 = 11;  // Tombol untuk running bolak-balik
